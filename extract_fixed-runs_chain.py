...
print("Scanning for FIXED RUNS chain experiments...")
...
for filepath in glob.glob(os.path.join(RESULTS_DIR, "*.json")):
    ...
    if "fixed_runs_chain_mc" in filename:
        method = "mc"
    elif "fixed_runs_chain_restart" in filename:
        method = "restart"
    else:
        continue
...
output_filename = "extracted_fixed_runs_chain.json"
