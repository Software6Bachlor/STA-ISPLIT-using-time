...
print("Scanning for FIXED RUNS long-sta experiments...")
...
for filepath in glob.glob(os.path.join(RESULTS_DIR, "*.json")):
    ...
    if "fixed_runs_long_mc" in filename:
        method = "mc"
    elif "fixed_runs_long_restart" in filename:
        method = "restart"
    else:
        continue
...
output_filename = "extracted_fixed_runs_long.json"
