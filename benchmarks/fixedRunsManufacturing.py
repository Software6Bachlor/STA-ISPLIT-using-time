...
def fixedRunsManufacturing(memoryMb, ifTimeLimit):
    constants = {
        "FAIL_W": 1.0, 
        "PASS_W": 9.0, 
        "TIME_BOUND": 10000.0
    ...
    for method in ["restart","mc"]:
        ...
        for scheduler_id in scheduler_ids:
            if method == "mc":
                ...
                writeResult(modelPath, model, STAsim.max_time, result, method="mc", schedulerID=scheduler_id, constants=constants, experimentName="fixed_runs_manufacturing_mc")
            elif method == "restart":
                ...
                writeResult(modelPath, model, STAsim.max_time, restartResult, method="restart", schedulerID=scheduler_id, constants=constants, experimentName="fixed_runs_manufacturing_restart", configElapsed=configElapsed)
