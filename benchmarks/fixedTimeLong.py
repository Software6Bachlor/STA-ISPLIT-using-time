...
def fixedTimeLong(memoryMb, ifTimeLimit):
    constants = {
        "RARE_LO": 1.0, 
        "Y_THRESHOLD": 110.0, 
        "TIME_BOUND": 100000.0 
    ...
    for method in ["restart","mc"]:
        ...
        for scheduler_id in scheduler_ids:
            if method == "mc":
                ...
                writeResult(modelPath, model, STAsim.max_time, result, method="mc", schedulerID=scheduler_id, constants=constants, experimentName="fixed_time_long_mc")
            elif method == "restart":
                ...
                writeResult(modelPath, model, STAsim.max_time, restartResult, method="restart", schedulerID=scheduler_id, constants=constants, experimentName="fixed_time_long_restart", configElapsed=configElapsed)
